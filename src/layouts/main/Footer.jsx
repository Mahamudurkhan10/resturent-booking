        ...
        <div className='flex items-center gap-10'>
          <div>
            ...
            <div className='flex items-center gap-2'>
              {
                socialItems.map((item,index) =>  <a key={index} href={item.path} target='_blank' className='bg-white text-gray p-2 rounded-full hover:bg-primary duration-200 hover:text-white'>
                {item.icon}
              </a>)
              }
            </div>
